...
public class UserStoryGenerator : BaseTool
{
    public UserStoryGenerator(List<Role> roles, List<Category> categories) : base(roles, categories)
    {
        ...
        Positions = new[] { Position.BusinessAnalyst, Position.ProductOwner };
        ...
        Name = "User Story Generator";
           ...
           ProcessingMethod = "Analyzes requirements, identifies key user roles and needs, and formulates user stories focusing on user goals and benefits.";
        SuggestedGuidance = @"
...
";
        SystemPrompt = @"
# Instructions for User Story Generator
